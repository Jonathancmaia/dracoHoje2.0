...
Route::get('getDracoNow', 'App\Http\Controllers\DracoController@getDracoNow')->name('getDracoNow');
...
Route::get('getHydraNow', 'App\Http\Controllers\HydraController@getHydraNow')->name('getHydraNow');